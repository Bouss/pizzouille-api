...
class HandlerMapper
{
     ...
     * @throws ReflectionException
     */
    private static function extractFirstParam(object $handler): string
    {
        ...
        if (!$paramType instanceof ReflectionNamedType) {
            throw new LogicException(sprintf('Parameter type of __invoke method of handler "%s" must be a named type', $handler::class));
        }
